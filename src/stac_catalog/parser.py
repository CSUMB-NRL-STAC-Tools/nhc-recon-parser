...
def parse_temp_drop(message: str, filename: str):
    ...
    parsed_data = {
        "message_date": id_datetime_part,  # Default to current UTC time
        "header": {},
...
def convert_dropsonde_to_stac_item(dropsonde_data: dict, dropsonde_url: str) -> pystac.Item:
    ...
    dt_utc_string = dropsonde_data['message_date'].isoformat() + 'Z'  # This should be a datetime object in UTC
    ...
    # 3. Properties: Add all relevant metadata from the dropsonde message.
